...
public class TwitterAllAdapter extends AdapterApp implements Runnable {

	private static Logger logger = LoggerFactory
			.getLogger(TwitterAllAdapter.class);
	...
	public void run() {
		...
		logger.info("Finish TwitterAllAdapter");
	}
